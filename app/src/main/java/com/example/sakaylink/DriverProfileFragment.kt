...
class DriverProfileFragment : Fragment() {
    ...
    private lateinit var driverLicenseOption: LinearLayout
    private lateinit var vehicleInfoOption: LinearLayout
    ...
    private fun initializeViews(view: View) {
        ...
        driverLicenseOption = view.findViewById(R.id.driver_info_option)
        vehicleInfoOption = view.findViewById(R.id.vehicle_option)
    ...
    private fun setupClickListeners() {
        ...
        driverLicenseOption.setOnClickListener {
            startActivity(Intent(requireContext(), DriverLicenseActivity::class.java))
        }

        vehicleInfoOption.setOnClickListener {
            startActivity(Intent(requireContext(), VehicleInfoActivity::class.java))
        }
